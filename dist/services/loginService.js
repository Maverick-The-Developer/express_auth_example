...
const loginZod_1 = require("../z-schema/loginZod");
function loginCheck(loginInput) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const parsed = loginZod_1.loginSchema.safeParse(loginInput);
            if (parsed.success) {
                ...
                if (user !== null) {
                    ...
                    if (isPasswordMatch) {
                        const token = yield (0, auth_1.encrypt)({ id: user.id, email: user.email, role: user.role });
